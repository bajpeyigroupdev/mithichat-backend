...
export const sendCustomEmail = async (
  ...
  const subjects: Record<string, string> = {
    otp: `${data?.otp} is OTP for mithi chat Email verification`,
    forgotPassword: `${data?.otp} is OTP for mithi chat account forgot password`,
  ...
  const messages: Record<string, string> = {
    otp: `Your mithi chat Account One Time PIN is: <strong>${data?.otp}</strong>, and is valid for <strong>10 minutes</strong>.`,
    forgotPassword: `Your mithi chat Account change password One Time PIN is: <strong>${data?.otp}</strong>, and is valid for <strong>10 minutes</strong>.`,
...
export const sendOtpForEmailVerification = async (email: string, otp: string) => {
  const subject = `${otp} is your OTP for mithi chat Email Verification`;
  const message = `Your mithi chat Account One Time PIN (OTP) is: <strong>${otp}</strong>. It is valid for <strong>10 minutes</strong>. Please do not share it with anyone.`;
